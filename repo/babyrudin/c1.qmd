...
3. $\alpha$ is the greatest lower bound of $B$.
...
4. Since $\alpha = \sup L \in S$ and $\alpha = \inf B$, $S$ also has the greatest-lower-bound property. $\blacksquare$.
:::
